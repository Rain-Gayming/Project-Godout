...
@export var balloon: Control # %Balloon

## The label showing the name of the currently speaking character
@export var character_label: RichTextLabel # %CharacterLabel

## The label showing the currently spoken dialogue
@export var dialogue_label: DialogueLabel # %DialogueLabel

## The menu of responses
@export var responses_menu: DialogueResponsesMenu # %ResponsesMenu
